...
double legendreP_prolate(int u, int v, double x) {
  double y=0.0;
  switch(u) {
  case(0):
    switch (v) {
  ...
  case(5):
    ...
    case(1):
      ...
      break;
    case(2):
      y = 0.315e3 / 0.2e1 * (x * x - 0.1e1 / 0.3e1) * x * (x - 0.1e1) * (x + 0.1e1);
      break;
    case(3):
  ...
  case(18):
    ...
    case(2):
      ...
      break;
    case(3):
      y = 0.347123925225e12 / 0.2048e4 * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * pow(x - 0.1e1, 0.3e1 / 0.2e1) * (pow(x, 0.14e2) - 0.3e1 * pow(x, 0.12e2) + 0.39e2 / 0.11e2 * pow(x, 0.10e2) - 0.65e2 / 0.31e2 * pow(x, 0.8e1) + 0.585e3 / 0.899e3 * pow(x, 0.6e1) - 0.91e2 / 0.899e3 * pow(x, 0.4e1) + 0.91e2 / 0.13485e5 * x * x - 0.13e2 / 0.103385e6);
      break;
    case(4):
