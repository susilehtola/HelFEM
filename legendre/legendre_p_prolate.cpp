...
double legendreP_prolate(int u, int v, double x) {
  ...
  case(7):
    ...
    case(3):
      ...
      break;
    case(4):
      y = 0.45045e5 / 0.2e1 * (x * x - 0.3e1 / 0.13e2) * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * x;
      break;
    case(5):
  ...
  case(8):
    ...
    case(4):
      ...
      break;
    case(5):
      y = 0.675675e6 / 0.2e1 * pow(x - 0.1e1, 0.5e1 / 0.2e1) * (x * x - 0.1e1 / 0.5e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x;
      break;
    case(6):
