  ...
  double legendreP_prolate(int u, int v, double x) {
    ...
    case(7):
     ...
     case(3):
        ...
        break;
     case(4):
         y = 0.45045e5 / 0.2e1 * x * pow(x + 0.1e1, 0.2e1) * pow(x - 0.1e1, 0.2e1) * (x * x - 0.3e1 / 0.13e2);
        break;
     case(5):
    ...
    case(8):
     ...
     case(4):
        ...
        break;
     case(5):
         y = 0.675675e6 / 0.2e1 * pow(x - 0.1e1, 0.5e1 / 0.2e1) * x * (x * x - 0.1e1 / 0.5e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1);
        break;
     case(6):
    ...
    case(11):
     ...
     case(3):
        ...
        break;
     case(4):
         y = 0.43648605e8 / 0.16e2 * (pow(x, 0.6e1) - pow(x, 0.4e1) + 0.5e1 / 0.19e2 * x * x - 0.5e1 / 0.323e3) * x * pow(x + 0.1e1, 0.2e1) * pow(x - 0.1e1, 0.2e1);
        break;
     case(5):
    ...
    case(20):
     ...
     case(0):
        ...
        break;
     case(1):
         y = 0.172308161025e12 / 0.65536e5 * sqrt(x - 0.1e1) * (pow(x, 0.18e2) - 0.57e2 / 0.13e2 * pow(x, 0.16e2) + 0.3876e4 / 0.481e3 * pow(x, 0.14e2) - 0.3876e4 / 0.481e3 * pow(x, 0.12e2) + 0.1938e4 / 0.407e3 * pow(x, 0.10e2) - 0.1938e4 / 0.1147e4 * pow(x, 0.8e1) + 0.11628e5 / 0.33263e5 * pow(x, 0.6e1) - 0.1292e4 / 0.33263e5 * pow(x, 0.4e1) + 0.323e3 / 0.166315e6 * x * x - 0.323e3 / 0.11475735e8) * x * sqrt(x + 0.1e1);
        break;
     case(2):
