  ...
  double legendreP_prolate(int u, int v, double x) {
    ...
    case(5):
     ...
     case(1):
        ...
        break;
     case(2):
         y = 0.315e3 / 0.2e1 * (x - 0.1e1) * x * (x + 0.1e1) * (x * x - 0.1e1 / 0.3e1);
        break;
     case(3):
    ...
    case(7):
     ...
     case(3):
        ...
        break;
     case(4):
         y = 0.45045e5 / 0.2e1 * pow(x - 0.1e1, 0.2e1) * (x * x - 0.3e1 / 0.13e2) * x * pow(x + 0.1e1, 0.2e1);
        break;
     case(5):
    ...
    case(11):
     ...
     case(3):
        ...
        break;
     case(4):
         y = 0.43648605e8 / 0.16e2 * pow(x - 0.1e1, 0.2e1) * x * (pow(x, 0.6e1) - pow(x, 0.4e1) + 0.5e1 / 0.19e2 * x * x - 0.5e1 / 0.323e3) * pow(x + 0.1e1, 0.2e1);
        break;
     case(5):
