...
double legendreP(int u, int v, double x) {
  ...
  case(4):
    ...
    case(1):
      ...
      break;
    case(2):
      y = 0.105e3 / 0.2e1 * (x - 0.1e1) * (x + 0.1e1) * (x * x - 0.1e1 / 0.7e1);
      break;
    case(3):
  ...
  case(7):
    ...
    case(3):
      ...
      break;
    case(4):
      y = 0.45045e5 / 0.2e1 * (x * x - 0.3e1 / 0.13e2) * x * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1);
      break;
    case(5):
  ...
  case(8):
    ...
    case(4):
      ...
      break;
    case(5):
      y = 0.675675e6 / 0.2e1 * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (x * x - 0.1e1 / 0.5e1) * x * pow(x - 0.1e1, 0.5e1 / 0.2e1);
      break;
    case(6):
  ...
  case(9):
    ...
    case(5):
      ...
      break;
    case(6):
      y = 0.11486475e8 / 0.2e1 * x * pow(x - 0.1e1, 0.3e1) * pow(x + 0.1e1, 0.3e1) * (x * x - 0.3e1 / 0.17e2);
      break;
    default:
      fprintf(stderr,"%s(%i,%i) not implemented!\n",__FUNCTION__,u,v);
      exit(1);
  ...
  case(11):
    ...
    case(3):
      ...
      break;
    case(4):
      y = 0.43648605e8 / 0.16e2 * x * (pow(x, 0.6e1) - pow(x, 0.4e1) + 0.5e1 / 0.19e2 * x * x - 0.5e1 / 0.323e3) * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1);
      break;
    case(5):
  ...
  case(18):
    ...
    case(2):
      ...
      break;
    case(3):
      y = 0.347123925225e12 / 0.2048e4 * (pow(x, 0.14e2) - 0.3e1 * pow(x, 0.12e2) + 0.39e2 / 0.11e2 * pow(x, 0.10e2) - 0.65e2 / 0.31e2 * pow(x, 0.8e1) + 0.585e3 / 0.899e3 * pow(x, 0.6e1) - 0.91e2 / 0.899e3 * pow(x, 0.4e1) + 0.91e2 / 0.13485e5 * x * x - 0.13e2 / 0.103385e6) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * pow(x - 0.1e1, 0.3e1 / 0.2e1);
      break;
    case(4):
  ...
  case(20):
    ...
    case(0):
      ...
      break;
    case(1):
      y = 0.172308161025e12 / 0.65536e5 * sqrt(x + 0.1e1) * x * sqrt(x - 0.1e1) * (pow(x, 0.18e2) - 0.57e2 / 0.13e2 * pow(x, 0.16e2) + 0.3876e4 / 0.481e3 * pow(x, 0.14e2) - 0.3876e4 / 0.481e3 * pow(x, 0.12e2) + 0.1938e4 / 0.407e3 * pow(x, 0.10e2) - 0.1938e4 / 0.1147e4 * pow(x, 0.8e1) + 0.11628e5 / 0.33263e5 * pow(x, 0.6e1) - 0.1292e4 / 0.33263e5 * pow(x, 0.4e1) + 0.323e3 / 0.166315e6 * x * x - 0.323e3 / 0.11475735e8);
      break;
    case(2):
