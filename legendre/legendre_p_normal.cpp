  ...
  double legendreP(int u, int v, double x) {
    ...
    case(2):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.3e1 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x;
        break;
      case(2):
    ...
    case(3):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.3e1 / 0.2e1 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.5e1 * x * x - 0.1e1);
        break;
      case(2):
        y = -0.15e2 * (x - 0.1e1) * (x + 0.1e1) * x;
        break;
      case(3):
        y = -0.15e2 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1);
        break;
      default:
        fprintf(stderr,"%s(%i,%i) not implemented!\n",__FUNCTION__,u,v);
        exit(1);
    ...
    case(4):
      ...
      case(0):
        ...
        break;
      case(1):
        y = (-0.35e2 * pow(x, 0.3e1) + 0.15e2 * x) * sqrt(x + 0.1e1) * sqrt(0.1e1 - x) / 0.2e1;
        break;
      case(2):
        y = -0.105e3 / 0.2e1 * (x - 0.1e1) * (x * x - 0.1e1 / 0.7e1) * (x + 0.1e1);
        break;
      case(3):
        y = -0.105e3 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x;
        break;
      case(4):
    ...
    case(5):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.15e2 / 0.8e1 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.21e2 * pow(x, 0.4e1) - 0.14e2 * x * x + 0.1e1);
        break;
      case(2):
        y = -0.315e3 / 0.2e1 * (x - 0.1e1) * (x * x - 0.1e1 / 0.3e1) * x * (x + 0.1e1);
        break;
      case(3):
        y = -0.105e3 / 0.2e1 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.9e1 * x * x - 0.1e1);
        break;
      case(4):
        y = 0.945e3 * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * x;
        break;
      case(5):
        y = -0.945e3 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1);
        break;
      default:
        fprintf(stderr,"%s(%i,%i) not implemented!\n",__FUNCTION__,u,v);
        exit(1);
    ...
    case(6):
      ...
      case(0):
        ...
        break;
      case(1):
        y = (-0.693e3 * pow(x, 0.5e1) + 0.630e3 * pow(x, 0.3e1) - 0.105e3 * x) * sqrt(x + 0.1e1) * sqrt(0.1e1 - x) / 0.8e1;
        break;
      case(2):
        y = -0.3465e4 / 0.8e1 * pow(x, 0.6e1) + 0.5355e4 / 0.8e1 * pow(x, 0.4e1) - 0.1995e4 / 0.8e1 * x * x + 0.105e3 / 0.8e1;
        break;
      case(3):
        y = (-0.3465e4 * pow(x, 0.3e1) + 0.945e3 * x) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * pow(0.1e1 - x, 0.3e1 / 0.2e1) / 0.2e1;
        break;
      case(4):
        y = 0.945e3 / 0.2e1 * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * (0.11e2 * x * x - 0.1e1);
        break;
      case(5):
        y = -0.10395e5 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x;
        break;
      case(6):
    ...
    case(7):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.7e1 / 0.16e2 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.429e3 * pow(x, 0.6e1) - 0.495e3 * pow(x, 0.4e1) + 0.135e3 * x * x - 0.5e1);
        break;
      case(2):
        y = -0.9009e4 / 0.8e1 * pow(x, 0.7e1) + 0.15939e5 / 0.8e1 * pow(x, 0.5e1) - 0.7875e4 / 0.8e1 * pow(x, 0.3e1) + 0.945e3 / 0.8e1 * x;
        break;
      case(3):
        y = -0.315e3 / 0.8e1 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.143e3 * pow(x, 0.4e1) - 0.66e2 * x * x + 0.3e1);
        break;
      case(4):
        y = 0.45045e5 / 0.2e1 * pow(x - 0.1e1, 0.2e1) * x * (x * x - 0.3e1 / 0.13e2) * pow(x + 0.1e1, 0.2e1);
        break;
      case(5):
        y = -0.10395e5 / 0.2e1 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.13e2 * x * x - 0.1e1);
        break;
      case(6):
    ...
    case(8):
      ...
      case(0):
        ...
        break;
      case(1):
        y = (-0.6435e4 * pow(x, 0.7e1) + 0.9009e4 * pow(x, 0.5e1) - 0.3465e4 * pow(x, 0.3e1) + 0.315e3 * x) * sqrt(x + 0.1e1) * sqrt(0.1e1 - x) / 0.16e2;
        break;
      case(2):
        y = -0.45045e5 / 0.16e2 * pow(x, 0.8e1) + 0.45045e5 / 0.8e1 * pow(x, 0.6e1) - 0.3465e4 * pow(x, 0.4e1) + 0.5355e4 / 0.8e1 * x * x - 0.315e3 / 0.16e2;
        break;
      case(3):
        y = -0.3465e4 / 0.8e1 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.39e2 * pow(x, 0.4e1) - 0.26e2 * x * x + 0.3e1);
        break;
      case(4):
        y = 0.10395e5 / 0.8e1 * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * (0.65e2 * pow(x, 0.4e1) - 0.26e2 * x * x + 0.1e1);
        break;
      case(5):
        y = -0.675675e6 / 0.2e1 * (x * x - 0.1e1 / 0.5e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * pow(0.1e1 - x, 0.5e1 / 0.2e1);
        break;
      case(6):
        y = -0.2027025e7 / 0.2e1 * pow(x - 0.1e1, 0.3e1) * (x * x - 0.1e1 / 0.15e2) * pow(x + 0.1e1, 0.3e1);
        break;
      default:
        fprintf(stderr,"%s(%i,%i) not implemented!\n",__FUNCTION__,u,v);
        exit(1);
    ...
    case(9):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.45e2 / 0.128e3 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.2431e4 * pow(x, 0.8e1) - 0.4004e4 * pow(x, 0.6e1) + 0.2002e4 * pow(x, 0.4e1) - 0.308e3 * x * x + 0.7e1);
        break;
      case(2):
        y = -0.495e3 / 0.16e2 * (x - 0.1e1) * (x + 0.1e1) * x * (0.221e3 * pow(x, 0.6e1) - 0.273e3 * pow(x, 0.4e1) + 0.91e2 * x * x - 0.7e1);
        break;
      case(3):
        y = -0.3465e4 / 0.16e2 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.221e3 * pow(x, 0.6e1) - 0.195e3 * pow(x, 0.4e1) + 0.39e2 * x * x - 0.1e1);
        break;
      case(4):
        y = 0.135135e6 / 0.8e1 * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * x * (0.17e2 * pow(x, 0.4e1) - 0.10e2 * x * x + 0.1e1);
        break;
      case(5):
        y = -0.135135e6 / 0.8e1 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.85e2 * pow(x, 0.4e1) - 0.30e2 * x * x + 0.1e1);
        break;
      case(6):
        y = -0.11486475e8 / 0.2e1 * pow(x - 0.1e1, 0.3e1) * x * pow(x + 0.1e1, 0.3e1) * (x * x - 0.3e1 / 0.17e2);
        break;
      default:
        fprintf(stderr,"%s(%i,%i) not implemented!\n",__FUNCTION__,u,v);
        exit(1);
    ...
    case(10):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.55e2 / 0.128e3 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x * (0.4199e4 * pow(x, 0.8e1) - 0.7956e4 * pow(x, 0.6e1) + 0.4914e4 * pow(x, 0.4e1) - 0.1092e4 * x * x + 0.63e2);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.6435e4 / 0.16e2 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.323e3 * pow(x, 0.6e1) - 0.357e3 * pow(x, 0.4e1) + 0.105e3 * x * x - 0.7e1);
        break;
      case(4):
        y = 0.45045e5 / 0.16e2 * pow(x - 0.1e1, 0.2e1) * pow(x + 0.1e1, 0.2e1) * (0.323e3 * pow(x, 0.6e1) - 0.255e3 * pow(x, 0.4e1) + 0.45e2 * x * x - 0.1e1);
        break;
      case(5):
        y = -0.135135e6 / 0.8e1 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.323e3 * pow(x, 0.4e1) - 0.170e3 * x * x + 0.15e2);
        break;
      case(6):
    ...
    case(11):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.33e2 / 0.256e3 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.29393e5 * pow(x, 0.10e2) - 0.62985e5 * pow(x, 0.8e1) + 0.46410e5 * pow(x, 0.6e1) - 0.13650e5 * pow(x, 0.4e1) + 0.1365e4 * x * x - 0.21e2);
        break;
      case(2):
        y = -0.2145e4 / 0.128e3 * (x - 0.1e1) * (x + 0.1e1) * x * (0.2261e4 * pow(x, 0.8e1) - 0.3876e4 * pow(x, 0.6e1) + 0.2142e4 * pow(x, 0.4e1) - 0.420e3 * x * x + 0.21e2);
        break;
      case(3):
        y = -0.45045e5 / 0.128e3 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.969e3 * pow(x, 0.8e1) - 0.1292e4 * pow(x, 0.6e1) + 0.510e3 * pow(x, 0.4e1) - 0.60e2 * x * x + 0.1e1);
        break;
      case(4):
        y = 0.43648605e8 / 0.16e2 * pow(x - 0.1e1, 0.2e1) * (pow(x, 0.6e1) - pow(x, 0.4e1) + 0.5e1 / 0.19e2 * x * x - 0.5e1 / 0.323e3) * x * pow(x + 0.1e1, 0.2e1);
        break;
      case(5):
        y = -0.135135e6 / 0.16e2 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.2261e4 * pow(x, 0.6e1) - 0.1615e4 * pow(x, 0.4e1) + 0.255e3 * x * x - 0.5e1);
        break;
      case(6):
    ...
    case(12):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.39e2 / 0.256e3 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x * (0.52003e5 * pow(x, 0.10e2) - 0.124355e6 * pow(x, 0.8e1) + 0.106590e6 * pow(x, 0.6e1) - 0.39270e5 * pow(x, 0.4e1) + 0.5775e4 * x * x - 0.231e3);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.15015e5 / 0.128e3 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.7429e4 * pow(x, 0.8e1) - 0.11628e5 * pow(x, 0.6e1) + 0.5814e4 * pow(x, 0.4e1) - 0.1020e4 * x * x + 0.45e2);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.2297295e7 / 0.16e2 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.437e3 * pow(x, 0.6e1) - 0.399e3 * pow(x, 0.4e1) + 0.95e2 * x * x - 0.5e1);
        break;
      case(6):
    ...
    case(13):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.91e2 / 0.1024e4 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.185725e6 * pow(x, 0.12e2) - 0.490314e6 * pow(x, 0.10e2) + 0.479655e6 * pow(x, 0.8e1) - 0.213180e6 * pow(x, 0.6e1) + 0.42075e5 * pow(x, 0.4e1) - 0.2970e4 * x * x + 0.33e2);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.15015e5 / 0.256e3 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.37145e5 * pow(x, 0.10e2) - 0.66861e5 * pow(x, 0.8e1) + 0.40698e5 * pow(x, 0.6e1) - 0.9690e4 * pow(x, 0.4e1) + 0.765e3 * x * x - 0.9e1);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.2297295e7 / 0.128e3 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.10925e5 * pow(x, 0.8e1) - 0.12236e5 * pow(x, 0.6e1) + 0.3990e4 * pow(x, 0.4e1) - 0.380e3 * x * x + 0.5e1);
        break;
      case(6):
    ...
    case(14):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.105e3 / 0.1024e4 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x * (0.334305e6 * pow(x, 0.12e2) - 0.965770e6 * pow(x, 0.10e2) + 0.1062347e7 * pow(x, 0.8e1) - 0.554268e6 * pow(x, 0.6e1) + 0.138567e6 * pow(x, 0.4e1) - 0.14586e5 * x * x + 0.429e3);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.23205e5 / 0.256e3 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.58995e5 * pow(x, 0.10e2) - 0.120175e6 * pow(x, 0.8e1) + 0.86526e5 * pow(x, 0.6e1) - 0.26334e5 * pow(x, 0.4e1) + 0.3135e4 * x * x - 0.99e2);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.43648605e8 / 0.128e3 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.1725e4 * pow(x, 0.8e1) - 0.2300e4 * pow(x, 0.6e1) + 0.966e3 * pow(x, 0.4e1) - 0.140e3 * x * x + 0.5e1);
        break;
      case(6):
    ...
    case(15):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.15e2 / 0.2048e4 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.9694845e7 * pow(x, 0.14e2) - 0.30421755e8 * pow(x, 0.12e2) + 0.37182145e8 * pow(x, 0.10e2) - 0.22309287e8 * pow(x, 0.8e1) + 0.6789783e7 * pow(x, 0.6e1) - 0.969969e6 * pow(x, 0.4e1) + 0.51051e5 * x * x - 0.429e3);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.69615e5 / 0.1024e4 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.190095e6 * pow(x, 0.12e2) - 0.432630e6 * pow(x, 0.10e2) + 0.360525e6 * pow(x, 0.8e1) - 0.134596e6 * pow(x, 0.6e1) + 0.21945e5 * pow(x, 0.4e1) - 0.1254e4 * x * x + 0.11e2);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.43648605e8 / 0.256e3 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.10005e5 * pow(x, 0.10e2) - 0.15525e5 * pow(x, 0.8e1) + 0.8050e4 * pow(x, 0.6e1) - 0.1610e4 * pow(x, 0.4e1) + 0.105e3 * x * x - 0.1e1);
        break;
      case(6):
    ...
    case(16):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.17e2 / 0.2048e4 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x * (0.17678835e8 * pow(x, 0.14e2) - 0.59879925e8 * pow(x, 0.12e2) + 0.80528175e8 * pow(x, 0.10e2) - 0.54679625e8 * pow(x, 0.8e1) + 0.19684665e8 * pow(x, 0.6e1) - 0.3594591e7 * pow(x, 0.4e1) + 0.285285e6 * x * x - 0.6435e4);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.101745e6 / 0.1024e4 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.310155e6 * pow(x, 0.12e2) - 0.780390e6 * pow(x, 0.10e2) + 0.740025e6 * pow(x, 0.8e1) - 0.328900e6 * pow(x, 0.6e1) + 0.69069e5 * pow(x, 0.4e1) - 0.6006e4 * x * x + 0.143e3);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.3968055e7 / 0.256e3 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.310155e6 * pow(x, 0.10e2) - 0.550275e6 * pow(x, 0.8e1) + 0.341550e6 * pow(x, 0.6e1) - 0.88550e5 * pow(x, 0.4e1) + 0.8855e4 * x * x - 0.231e3);
        break;
      case(6):
    ...
    case(17):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.153e3 / 0.32768e5 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.64822395e8 * pow(x, 0.16e2) - 0.235717800e9 * pow(x, 0.14e2) + 0.345972900e9 * pow(x, 0.12e2) - 0.262462200e9 * pow(x, 0.10e2) + 0.109359250e9 * pow(x, 0.8e1) - 0.24496472e8 * pow(x, 0.6e1) + 0.2662660e7 * pow(x, 0.4e1) - 0.108680e6 * x * x + 0.715e3);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.14535e5 / 0.2048e4 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.10235115e8 * pow(x, 0.14e2) - 0.28224105e8 * pow(x, 0.12e2) + 0.30045015e8 * pow(x, 0.10e2) - 0.15540525e8 * pow(x, 0.8e1) + 0.4029025e7 * pow(x, 0.6e1) - 0.483483e6 * pow(x, 0.4e1) + 0.21021e5 * x * x - 0.143e3);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.43648605e8 / 0.1024e4 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.310155e6 * pow(x, 0.12e2) - 0.620310e6 * pow(x, 0.10e2) + 0.450225e6 * pow(x, 0.8e1) - 0.144900e6 * pow(x, 0.6e1) + 0.20125e5 * pow(x, 0.4e1) - 0.966e3 * x * x + 0.7e1);
        break;
      case(6):
    ...
    case(18):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.171e3 / 0.32768e5 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * x * (0.119409675e9 * pow(x, 0.16e2) - 0.463991880e9 * pow(x, 0.14e2) + 0.738168900e9 * pow(x, 0.12e2) - 0.619109400e9 * pow(x, 0.10e2) + 0.293543250e9 * pow(x, 0.8e1) - 0.78278200e8 * pow(x, 0.6e1) + 0.10958948e8 * pow(x, 0.4e1) - 0.680680e6 * x * x + 0.12155e5);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.347123925225e12 / 0.2048e4 * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (pow(x, 0.14e2) - 0.3e1 * pow(x, 0.12e2) + 0.39e2 / 0.11e2 * pow(x, 0.10e2) - 0.65e2 / 0.31e2 * pow(x, 0.8e1) + 0.585e3 / 0.899e3 * pow(x, 0.6e1) - 0.91e2 / 0.899e3 * pow(x, 0.4e1) + 0.91e2 / 0.13485e5 * x * x - 0.13e2 / 0.103385e6) * x * pow(0.1e1 - x, 0.3e1 / 0.2e1);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.77224455e8 / 0.1024e4 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.471975e6 * pow(x, 0.12e2) - 0.1051830e7 * pow(x, 0.10e2) + 0.876525e6 * pow(x, 0.8e1) - 0.339300e6 * pow(x, 0.6e1) + 0.61425e5 * pow(x, 0.4e1) - 0.4550e4 * x * x + 0.91e2);
        break;
      case(6):
    ...
    case(19):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.95e2 / 0.65536e5 * sqrt(0.1e1 - x) * sqrt(x + 0.1e1) * (0.883631595e9 * pow(x, 0.18e2) - 0.3653936055e10 * pow(x, 0.16e2) + 0.6263890380e10 * pow(x, 0.14e2) - 0.5757717420e10 * pow(x, 0.12e2) + 0.3064591530e10 * pow(x, 0.10e2) - 0.951080130e9 * pow(x, 0.8e1) + 0.164384220e9 * pow(x, 0.6e1) - 0.14090076e8 * pow(x, 0.4e1) + 0.459459e6 * x * x - 0.2431e4);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.1119195e7 / 0.32768e5 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * (0.11475735e8 * pow(x, 0.16e2) - 0.37218600e8 * pow(x, 0.14e2) + 0.48384180e8 * pow(x, 0.12e2) - 0.32256120e8 * pow(x, 0.10e2) + 0.11705850e8 * pow(x, 0.8e1) - 0.2260440e7 * pow(x, 0.6e1) + 0.209300e6 * pow(x, 0.4e1) - 0.7176e4 * x * x + 0.39e2);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.77224455e8 / 0.2048e4 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * (0.2494725e7 * pow(x, 0.14e2) - 0.6135675e7 * pow(x, 0.12e2) + 0.5785065e7 * pow(x, 0.10e2) - 0.2629575e7 * pow(x, 0.8e1) + 0.593775e6 * pow(x, 0.6e1) - 0.61425e5 * pow(x, 0.4e1) + 0.2275e4 * x * x - 0.13e2);
        break;
      case(6):
    ...
    case(20):
      ...
      case(0):
        ...
        break;
      case(1):
        y = -0.172308161025e12 / 0.65536e5 * sqrt(x + 0.1e1) * x * (pow(x, 0.18e2) - 0.57e2 / 0.13e2 * pow(x, 0.16e2) + 0.3876e4 / 0.481e3 * pow(x, 0.14e2) - 0.3876e4 / 0.481e3 * pow(x, 0.12e2) + 0.1938e4 / 0.407e3 * pow(x, 0.10e2) - 0.1938e4 / 0.1147e4 * pow(x, 0.8e1) + 0.11628e5 / 0.33263e5 * pow(x, 0.6e1) - 0.1292e4 / 0.33263e5 * pow(x, 0.4e1) + 0.323e3 / 0.166315e6 * x * x - 0.323e3 / 0.11475735e8) * sqrt(0.1e1 - x);
        break;
      case(2):
        ...
        break;
      case(3):
        y = -0.1514205e7 / 0.32768e5 * pow(0.1e1 - x, 0.3e1 / 0.2e1) * pow(x + 0.1e1, 0.3e1 / 0.2e1) * x * (0.19458855e8 * pow(x, 0.16e2) - 0.67856520e8 * pow(x, 0.14e2) + 0.96282900e8 * pow(x, 0.12e2) - 0.71524440e8 * pow(x, 0.10e2) + 0.29801850e8 * pow(x, 0.8e1) - 0.6921720e7 * pow(x, 0.6e1) + 0.835380e6 * pow(x, 0.4e1) - 0.44200e5 * x * x + 0.663e3);
        break;
      case(4):
        ...
        break;
      case(5):
        y = -0.386122275e9 / 0.2048e4 * pow(0.1e1 - x, 0.5e1 / 0.2e1) * pow(x + 0.1e1, 0.5e1 / 0.2e1) * x * (0.1297257e7 * pow(x, 0.14e2) - 0.3492615e7 * pow(x, 0.12e2) + 0.3681405e7 * pow(x, 0.10e2) - 0.1928355e7 * pow(x, 0.8e1) + 0.525915e6 * pow(x, 0.6e1) - 0.71253e5 * pow(x, 0.4e1) + 0.4095e4 * x * x - 0.65e2);
        break;
      case(6):
