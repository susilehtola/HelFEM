...
!
  ...
  REAL(idp), DIMENSION(3,2)               :: point
  REAL(idp), DIMENSION(3)                 :: a_p
  REAL(idp), DIMENSION(2)                 :: x_i
  REAL(idp), DIMENSION(2)                 :: eta_i
  REAL(idp), DIMENSION(2)                 :: rho_i
  REAL(idp), DIMENSION(2)                 :: varphi
  REAL(idp), DIMENSION(2)                 :: r
  REAL(idp), DIMENSION(3)                 :: dr
  REAL(idp)                               :: xi_small
  REAL(idp)                               :: xi_large
  REAL(idp)                               :: facm
  REAL(idp)                               :: vardm
